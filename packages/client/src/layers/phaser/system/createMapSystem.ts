...
export function createMapSystem(network: NetworkLayer, phaser: PhaserLayer) {
  ...
  const label1 = phaserScene.add.text(32, -320, "5", { fontSize: "24px", color: "#c0c0c0" });
  const circle2 = phaserScene.add.circle(32, 32);
  const label2 = phaserScene.add.text(32, -640, "10", { fontSize: "24px", color: "#c0c0c0" });
  const circle3 = phaserScene.add.circle(32, 32);
  const label3 = phaserScene.add.text(32, -960, "15", { fontSize: "24px", color: "#c0c0c0" });
  const circle4 = phaserScene.add.circle(32, 32);
  const label4 = phaserScene.add.text(32, -1280, "20", { fontSize: "24px", color: "#c0c0c0" });
  const circle5 = phaserScene.add.circle(32, 32);
  const label5 = phaserScene.add.text(32, -1600, "25", { fontSize: "24px", color: "#c0c0c0" });
  const circle6 = phaserScene.add.circle(32, 32);
  const label6 = phaserScene.add.text(32, -1920, "30", { fontSize: "24px", color: "#c0c0c0" });
  const circle7 = phaserScene.add.circle(32, 32);
  const label7 = phaserScene.add.text(32, -2560, "35", { fontSize: "24px", color: "#c0c0c0" });
  const circle8 = phaserScene.add.circle(32, 32);
  const label8 = phaserScene.add.text(32, -2880, "40", { fontSize: "24px", color: "#c0c0c0" });
  const circle9 = phaserScene.add.circle(32, 32);
  const label9 = phaserScene.add.text(32, -3200, "45", { fontSize: "24px", color: "#c0c0c0" });
  const circle10 = phaserScene.add.circle(32, 32);
  const label10 = phaserScene.add.text(32, -3520, "50", { fontSize: "24px", color: "#c0c0c0" });
  ...
  circle10.setDisplaySize(3840, 3840);
