...
export const RailGunShipDetailsDetails = ({ layers }: { layers: Layers }) => {
  ...
  if (selectedEntity) {
    ...
    if (entityType && +entityType === Mapping.railGunShip.id) {
      return (
        <div>
          <S.Container>
            <S.Column>
              <S.Text>RAILGUN SHIP</S.Text>
              <img src={`/game-2/railGunShip.png`} width="100px" height="100px" style={{ objectFit: "contain" }} />
              <S.Text>
