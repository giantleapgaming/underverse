...
export const LaserShipDetailsDetails = ({ layers }: { layers: Layers }) => {
  ...
  if (selectedEntity) {
    ...
    if (entityType && +entityType === Mapping.laserShip.id) {
      return (
        <div>
          <S.Container>
            <S.Column>
              <S.Text>LASER SHIP</S.Text>
              <img src={`/game-2/laserShip.png`} width="100px" height="100px" style={{ objectFit: "contain" }} />
              <S.Text>
