...
export const PDCShipDetailsDetails = ({ layers }: { layers: Layers }) => {
  ...
  if (selectedEntity) {
    ...
    if (entityType && +entityType === Mapping.pdcShip.id) {
      return (
        <div>
          <S.Container>
            <S.Column>
              <S.Text>PDC SHIP</S.Text>
              <img src={`/game-2/pdcShip.png`} width="100px" height="100px" style={{ objectFit: "contain" }} />
              <S.Text>
